	...
	return (
		<div className="flex flex-col gap-8 max-h-[80vh] overflow-y-auto">
			...
			>
				...
				<form.Field name="characterCountry">
					{(field) => {
						return (
							<div className="space-y-2">
							...
							<div className="space-y-2">
								...
								<Select name="oceanColor">
									...
									>
										...
										<SelectItem value="rouge éclatant">
											Rouge éclatant
										</SelectItem>
				...
				<form.Field name="inOceanPerceivedObject">
					{(field) => {
						return (
							<div className="space-y-2">
								...
								<Select name="inOceanPerceivedObject">
									...
									>
										...
										<SelectItem value="poissons zébré">
											Poisson zébré
										</SelectItem>
